...
architecture behavioral of project_reti_logiche is
    ...
    signal c_central_3 : signed(7 downto 0) := to_signed(0, 8);
    ...
    signal c_central_5 : signed(7 downto 0) := to_signed(0, 8);
...
begin
    ...
    process (i_clk, i_rst) is
        ...
        variable tmp_central : signed(31 downto 0) := to_signed(0, 32);
            ...
            if i_start = '1' then
                case state is
                        ...
                        if s = '0' then -- filtro ordine 3
                            ...
                            case coeff_counter is
                                ...
                                when 1 =>
                                    ...
                                    o_mem_addr <= std_logic_vector(unsigned(mem_init_addr) + 6);

                                when 2 =>
                                    c_central_3 <= signed(i_mem_data);
                            ...
                            case coeff_counter is
                                ...
                                when 2 =>
                                    ...
                                    o_mem_addr <= std_logic_vector(unsigned(mem_init_addr) + 13);

                                when 3 =>
                                    c_central_5 <= signed(i_mem_data);
                    ...
                    when COMPUTE_ORDER_3 =>
                        ...
                        tmp_central := resize(c_central_3, 16) * resize(current_W, 16);
                        tmp_p1 := resize(c_p1_3, 16) * resize(next1, 16);
                        tmp_p2 := resize(c_p2_3, 16) * resize(next2, 16);

                        tmp_sum := tmp_n2 + tmp_n1 + tmp_central + tmp_p1 + tmp_p2;
